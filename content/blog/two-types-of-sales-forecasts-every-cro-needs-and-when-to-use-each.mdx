...
Notice these are binary gates, not probability estimates. A deal either has executive sponsorship or it doesn't. Budget is either confirmed or it's "probably there." (These criteria map directly to [MEDDIC](/resources/frameworks/qualification/meddic) and [MEDDPICC](/resources/frameworks/qualification/meddpicc) qualification frameworks—Economic Buyer, Champion, Paper Process, and Decision Criteria.)
