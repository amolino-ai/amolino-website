    ...
    <div className="relative isolate overflow-hidden bg-white dark:bg-gray-900">
      ...
      <div className="mx-auto max-w-7xl px-6 pt-10 pb-24 sm:pb-32 lg:flex lg:px-8 lg:py-40">
        <div className="mx-auto max-w-2xl lg:mx-0 lg:shrink-0 lg:pt-8">
          ...
          <div className="mt-10 grid grid-cols-1 gap-8 sm:grid-cols-3 sm:gap-6">
            {content.stats.map((stat, index) => (
              <div key={index}>
                ...
                <div className="mt-2 text-sm text-gray-600 dark:text-gray-400">{stat.description}</div>
              </div>
            ))}
          </div>
          ...
          {/* Tertiary CTA */}
          <div className="mt-6">
            <a href={content.ctas.tertiaryUrl} className="text-sm/6 font-medium text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white">
