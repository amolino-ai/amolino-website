            ...
            <div className="space-y-6">
              ...
              <div className="rounded-lg border border-neutral-200 p-6">
                ...
                <div className="space-y-4">
                  <div>
                    <h5 className="font-medium text-neutral-900">Sales:</h5>
                    <p className="text-neutral-700">
                      ARR, ACV, win rate, cycle length, pipeline coverage.
                    </p>
                  </div>
                  <div>
                    <h5 className="font-medium text-neutral-900">CS:</h5>
                    <p className="text-neutral-700">
                      NRR, GRR, logo churn, at-risk ARR, NPS themes.
                    </p>
                  </div>
                  <div>
                    <h5 className="font-medium text-neutral-900">Marketing:</h5>
                    <p className="text-neutral-700">
                      MQL → SQL conversion, pipeline $ sourced, CAC, CAC payback.
                    </p>
                  </div>
                  <div>
                    <h5 className="font-medium text-neutral-900">Product:</h5>
                    <p className="text-neutral-700">
                      Release velocity, adoption %, uptime, P0 bug count.
                    </p>
                  </div>
                  <div>
                    <h5 className="font-medium text-neutral-900">Finance:</h5>
                    <p className="text-neutral-700">
