  ...
  return (
    <section id="summary" className="scroll-mt-20">
      ...
      <div className="mt-6 py-4">
        <Text className="text-lg text-zinc-700 dark:text-zinc-300 mb-8">
        ...
        <Box className="space-y-6 mb-8">
          <Box className="space-y-2">
            ...
            <Text className="text-zinc-700 dark:text-zinc-300 ml-6">
          ...
          <Box className="space-y-2">
            ...
            <Box className="ml-6">
              <List className="text-zinc-700 dark:text-zinc-300">
