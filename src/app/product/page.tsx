...
const products = [
  {
    ...
    description:
      'From Pipeline Surprises to Pipeline Clarity. AI-powered revenue analytics transforms chaotic pipeline data into actionable intelligence.',
    features: ['Real-time forecast accuracy', 'Data-driven decision making', 'Eliminate biases'],
  ...
  },
  {
    ...
    features: ['Clear next steps', 'Stakeholder mapping', 'Proven success paths'],
  ...
  },
  {
    ...
    features: ['Team performance analytics', 'Pipeline health metrics', 'Coaching opportunities'],
  ...
  },
  {
    ...
    features: ['Customer intelligence', 'Engagement tracking', 'Relationship insights'],
