...
export function BlindSalesSection({ content }: BlindSalesSectionProps) {
  ...
  return (
    <section ref={sectionRef} className="relative py-20">
      ...
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_center,_var(--tw-gradient-stops))] from-primary-50/30 via-transparent to-transparent opacity-50" />
      ...
      <Container>
        <div className="max-w-3xl mx-auto space-y-12 relative">
          ...
          >
            ...
            <motion.div variants={item}>
              <Subheading className="text-xl md:text-2xl font-semibold text-neutral-800">
                {content.subheading}
              </Subheading>
            </motion.div>
          </motion.div>
          ...
          >
            {content.problems.map((problem, index) => (
              ...
              >
                <motion.div
                  className="absolute inset-0 bg-gradient-to-r from-error-50 to-secondary-50 rounded-xl"
                  initial={{ opacity: 0 }}
                  animate={{ opacity: 1 }}
                ...
                >
                  <div className="flex items-start gap-4">
                    <motion.div
                      className="flex-shrink-0 h-10 w-10 rounded-full bg-error-100 flex items-center justify-center"
