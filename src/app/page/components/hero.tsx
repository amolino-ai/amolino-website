    ...
    <div className="relative">
      ...
      <Container className="relative">
        <div className="pt-1 pb-24 sm:pt-24 sm:pb-32 md:pt-24 md:pb-48">
          <p className="mb-4 text-lg font-medium text-neutral-950/75">Quarter‑Ends without Pipeline Panic</p>
          <h1 className="font-display text-5xl/[1.1] font-semibold tracking-normal text-balance text-neutral-950 drop-shadow-sm sm:text-6xl/[1.05] md:text-6xl/[1.05]">
            The AI Platform for Sales Forecasting, Pipeline Visibility, and Deal Execution.
          </h1>
          <p className="mt-8 max-w-3xl text-xl/7 font-medium text-neutral-950/75 sm:text-2xl/8">
            Deal-level telemetry —spot risk before you lose a deal, improve forecast accuracy, and guide every rep to
            close faster.
          </p>
